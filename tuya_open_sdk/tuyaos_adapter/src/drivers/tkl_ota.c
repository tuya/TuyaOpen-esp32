...
{
    if (0 == image_size) {
        ESP_LOGE(DBG_TAG, "%s: invalid ota image size %ld", __func__, image_size);
...
*/
TUYA_WEAK_ATTRIBUTE OPERATE_RET tkl_ota_get_ability(uint32_t *image_size, TUYA_OTA_TYPE_E *type)
{
