...
OPERATE_RET tkl_pwm_init(TUYA_PWM_NUM_E ch_id, const TUYA_PWM_BASE_CFG_T *cfg)
{
    ...
    ledc_set_pin(ch_id, LEDC_LOW_SPEED_MODE, LEDC_CHANNEL_0);
...
/**
 * @brief multiple pwm channel start 多个PWM通道启动
 *
...
/**
 * @brief multiple pwm channel stop 多个PWM通道停止
 *
 * @param[in] ch_id: pwm channal id list
...
/**
 * @brief pwm frequency set 设置PWM频率
 *
 * @param[in] ch_id: pwm channal id, id index starts at 0
...
/**
 * @brief pwm polarity set PWM 极性设置
 *
 * @param[in] ch_id: pwm channal id, id index starts at 0
