                    ...
                    const TUYA_TRANS_TYPE_E type)
{
    ...
    if(0 != tkl_net_setsockopt(fd, SOL_SOCKET, optname, (const char *)&timeout, sizeof(timeout))) {
        return OPRT_COM_ERROR;
    }
                    ...
                    const TUYA_TRANS_TYPE_E type)
{
    ...
    if(0 != tkl_net_setsockopt(fd, SOL_SOCKET, optname, (const char *)&size, sizeof(size))) {
        return OPRT_COM_ERROR;
    }
...
{
    int flag = 1;
    if(0 != tkl_net_setsockopt(fd,SOL_SOCKET,SO_REUSEADDR,(const char*)&flag,sizeof(int))) {
        return OPRT_COM_ERROR;
    }
...
{
    int flag = 1;
    if(0 != tkl_net_setsockopt(fd,IPPROTO_TCP,TCP_NODELAY,(const char*)&flag,sizeof(int))) {
        return OPRT_COM_ERROR;
    }
...
{
        int flag = 1;
    if(0 != tkl_net_setsockopt(fd,SOL_SOCKET,SO_BROADCAST,(const char*)&flag,sizeof(int))) {
        return OPRT_COM_ERROR;
    }
...
* @return OPRT_OK on success. Others on error, please refer to tuya_error_code.h
*/
OPERATE_RET tkl_net_set_keepalive(int fd,const BOOL_T alive,
